...
export function SiteHeader() {
  ...
  return (
    <>
      ...
      <header
        className={cn(
          "sticky top-0 z-40 border-b border-white/10 px-0 pt-0 backdrop-blur-xl",
          isHome ? "bg-black/38" : "bg-black/58"
        )}
      >
        <div
          className={cn(
            "container flex h-16 items-center justify-between gap-4 px-4 md:px-6",
            "text-white"
          )}
        >
