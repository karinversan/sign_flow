      ...
      <div className="mx-auto w-full max-w-[1520px] px-4 md:px-6">
        <div className="page-head flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div className="max-w-3xl">
            ...
            <p className="page-lead">
              Большая рабочая область: крупный preview, быстрые настройки справа и редактирование сегментов снизу.
            </p>
          </div>
        ...
        <Card className="border-white/10 bg-black/45">
          <CardHeader>
            ...
            <CardDescription>Загрузите один файл и сразу переходите в workspace-редактор.</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        {fileName && (
          <>
            ...
            <div className="mt-5 grid gap-5 xl:grid-cols-[1.9fr_0.9fr]">
              <Card className="border-white/10 bg-black/45">
                <CardHeader>
                  <CardTitle>2) Большой preview</CardTitle>
                  <CardDescription>Центральная рабочая зона для проверки итогового слоя перевода.</CardDescription>
                </CardHeader>
                <CardContent>
                  ...
                  <div className="mt-3 rounded-lg border border-white/10 bg-white/[0.02] p-3">
                    ...
                    <Slider min={0} max={100} step={1} value={[playhead]} onValueChange={(v) => setPlayhead(v[0] ?? 0)} />
                  </div>
                </CardContent>
              </Card>
              ...
              <div className="space-y-5 xl:sticky xl:top-24 xl:self-start">
                <Card className="border-white/10 bg-black/45">
                  <CardHeader>
                    <CardTitle>3) Панель вывода</CardTitle>
                    <CardDescription>Все параметры в одном месте.</CardDescription>
                  </CardHeader>
                  <CardContent>
                ...
                <Card className="border-white/10 bg-black/45">
                  <CardHeader>
                    <CardTitle>4) Экспорт</CardTitle>
                    <CardDescription>Файлы формируются из текущего состояния редактора.</CardDescription>
                  </CardHeader>
            ...
            <Card className="mt-5 border-white/10 bg-black/45">
              <CardHeader>
                <div className="flex flex-wrap items-center justify-between gap-3">
                  <div>
                    <CardTitle>5) Редактор сегментов</CardTitle>
                    <CardDescription>Формат как рабочая область переводчика: список + активный текст + voice script.</CardDescription>
                  </div>
              ...
              <CardContent className="grid gap-4 xl:grid-cols-[0.5fr_0.5fr]">
                ...
                <div className="space-y-2 rounded-xl border border-white/10 bg-white/[0.02] p-3">
                  ...
                  <Textarea className="min-h-[250px]" value={voiceoverScript} readOnly />
                  <p className="text-xs text-muted-foreground">
                    Любая правка сегментов автоматически обновляет текст для озвучки.
                  </p>
                </div>
              </CardContent>
            </Card>
